...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		text("LandQuake",75,140);
		text("OcenQuake",75,155);
	...
	private void printQuakes() 
	{
		...
		//        String country = (String)m.getProperty("country");
		 ...
		 for(Marker m : countryMarkers){
			 int quakeCount = 0;
			 String cCountry = (String)m.getStringProperty("name");
			 for(Marker qm: quakeMarkers){
				
				 if(qm instanceof LandQuakeMarker){
					 
					 
					 String qCountry = (String)qm.getStringProperty("country");
					 if(cCountry.equals(qCountry)){
						 quakeCount++;
					 }
			 ...
			 if(quakeCount > 0){
				 totalOceanQuakes -= quakeCount;
				 System.out.println(cCountry+" : "+quakeCount);
			 }
		 }
